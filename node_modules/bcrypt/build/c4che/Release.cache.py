...
CPPPATH_NODE = '/home/travis/nvm/v0.6.19/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
HAVE_RAND_BYTES = ()
LIBDIR = '/home/travis/.node_libraries'
LIBPATH_NODE = '/home/travis/nvm/v0.6.19/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CC = ['/usr/bin/gcc']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/travis/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/home/travis/nvm/v0.6.19'
